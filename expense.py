...
def show_all_expenses():
    ...
    for expense in expenses:
        print(
            f"ID:{expense[0]} | {expense[1]} - R{expense[2]} on {expense[3]}")
...
while True:
    ...
    # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
        ...
        # ==================================
            ...
            # ---------------------------------------------------------------------------------------------------------------
            expense_id = input(
                "Please select an ID to update or q to return to main menu")
            cursor.execute(
                """
                SELECT * FROM expenses
                WHERE id = ?
    ...
    # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
        ...
        if choice5 == '1':
            ...
            selected_category = show_all_categories()

            show_expenses_by_category(selected_category)

            delete_id = input("Please enter the ID you wish to delete or enter q to return to main menu\n")
