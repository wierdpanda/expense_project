...
while True:
    choice = input("Do you wish to clear previous save data? (Y/N) ").lower()
    if choice == "y":
...
while True:
    ...
    if choice == "1":
        while True:
            user_input = input("\nEnter expense name and amount (or q to return to previous menu): ")
